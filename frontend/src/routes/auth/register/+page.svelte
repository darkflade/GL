    ...
    <div class="auth-container">
        <div class="auth-card glass-panel">
            <div class="auth-header">
                <h1 class="auth-title text-gradient">Join Glab</h1>
                <p class="auth-subtitle">Create an account to start your visual journey.</p>
            </div>
            ...
            <form class="auth-form" onsubmit={handleRegister}>
                ...
                <div class="auth-actions">
                    <Button type="submit" variant="primary" size="lg" width="full">Create Account</Button>
                </div>
            </form>
